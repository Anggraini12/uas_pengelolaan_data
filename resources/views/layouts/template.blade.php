            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                ...
                <div class="nav-profile-text">
                  <p class="mb-1 text-black">Penti Anggraini</p>
                </div>
              </a>
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                ...
                <a class="dropdown-item preview-item">
                  ...
                  <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                    ...
                    <p class="text-gray ellipsis mb-0"> Tanggal Masuk </p>
                  </div>
                </a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item preview-item">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a href="/statuspenduduk" class="nav-link">
                <span class="icon-bg"><i class="mdi mdi-contacts menu-icon"></i></span>
                <span class="menu-title">Status Penduduk</span>
              </a>
            </li>
            <li class="nav-item">
                  ...
                  <div>
                    <div class="d-flex align-items-center">
                      ...
                      <div class="sidebar-profile-text">
                        <p class="mb-1">Penti Anggraini</p>
                      </div>
                    </div>
                  </div>
          ...
          <footer class="footer">
            <div class="footer-inner-wraper">
              <div class="d-sm-flex justify-content-center justify-content-sm-between">
                <span class="text-muted d-block text-center text-sm-left d-sm-inline-block"> © Penti Anggraini</span>
